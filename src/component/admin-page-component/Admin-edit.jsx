...
export function AdminEdit() {
  ...
  const fetchData = async () => {
    ...
    setAutherName(result.data.author);
    ...
    <div className="body w-full h-screen bg-[#F9F8F6] pb-20 px-16 ">
      ...
      <form action="post" className="flex flex-col gap-7 px-16 pb-32 pt-10">
          ...
          <div className="flex items-end space-x-4">
            {thumbnail ? (
              <img
                src={thumbnail}
                alt=""
                className="flex justify-center items-center object-cover w-full max-w-lg border-2 border-gray-300 border-dashed rounded-md bg-gray-50"
              />
            ) : (
              <div className="thumnail-frame flex justify-center items-center w-full max-w-lg h-64 px-6 py-20 border-2 border-gray-300 border-dashed rounded-md bg-gray-50">
        ...
        <div className="category flex flex-col">
          ...
          <Select value={category} onValueChange={handleSelector}>
